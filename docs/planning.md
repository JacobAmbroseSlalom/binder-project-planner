...
- Language: TypeScript
- Database: **TBD** — SQLite is a strong option for the local single-user deployment.
...
- The database technology remains TBD, with SQLite documented as a strong option for the local single-user deployment.
