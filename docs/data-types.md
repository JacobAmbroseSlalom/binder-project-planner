...
| `source`         | enum                                        | Yes          | `tcgdex`, `pokemontcg` (Story 43), or `custom`.                                                                                                                                                                                                                                                                                                                            |
| `providerCardId` | string                                      | Conditional  | Required for `tcgdex` and `pokemontcg`; absent for `custom`. For `pokemontcg`, this is pokemontcg.io's own card `id` (e.g. `"xy1-1"`).                                                                                                                                                                                                                                     |
| `providerSetId`  | string                                      | Conditional  | Required for `tcgdex` and `pokemontcg`; absent for `custom`. For `pokemontcg`, this is that card's pokemontcg.io `set.id`.                                                                                                                                                                                                                                                 |
...
| `source`         | enum                                        | Yes      | `tcgdex`, `pokemontcg` (Story 43), or `custom`, mirroring `Card.source`.                                                                                                |
