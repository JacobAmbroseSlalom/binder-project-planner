...
export function BinderRouteProvider({
  ...
  const value = useMemo<BinderRouteContextValue | null>(() => {
    ...
    return {
      ...
      editCardDetails: cardMutations.editCardDetails,
      pendingCardDetailsEditIds: cardMutations.pendingCardDetailsEditIds,
      ...
      toggleCardsAcquisition: cardMutations.toggleCardsAcquisition,
      isBulkAcquisitionPending: cardMutations.isBulkAcquisitionPending,
    ...
    cardMutations.editCardDetails,
    cardMutations.pendingCardDetailsEditIds,
    cardMutations.toggleCardAcquired,
    cardMutations.pendingCardAcquiredToggleIds,
    cardMutations.toggleCardsAcquisition,
    cardMutations.isBulkAcquisitionPending,
