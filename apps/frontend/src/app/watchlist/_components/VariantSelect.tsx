...
// Story 45's per-row print-variant selector for the What I'm Looking For
// page's price-review table - an unmodified copy of the Card List tab's
// own `VariantSelect` (cardlist/_components/VariantSelect.tsx), which is
// already generic (`CardPriceVariant`, not `Card`-coupled).
